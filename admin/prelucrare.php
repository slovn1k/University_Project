<?php
			...
			$order = "insert into video (`titlu`, `descriere`,`src`, `data_adaugare`, `link`) values ('$_POST[titlu]', '$_POST[descriere]','$_POST[src]', '$_POST[data_adaugare]', '$_POST[link]')";
    ...
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li><a href='add.php'>Adaugare</a></li>	
        </ul>
      </div>
    </div>
    <div id="site_content">
