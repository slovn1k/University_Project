  ...
  <div id="main">
    ...
    <div id="site_content">
      <div id="content">
		...
		<div class='main'>
			<div class='field'>
				<label>Inserati titlul pentru video: </label><input type='text' name='titlu'></br>
			</div>

			<div class='field'>
				<label>Inserati descrierea pentru video: </label>
			...
			<div class='field'>
				<label>Inserati locarea a fisierului sursa: </label>
				<input type='text' name='src'></br>
			</div>

			<div class='field'>
				<label>Inserati data adaugarii pentru video: </label><input type='date' min='2013-01-01' max='2400-01-01' value='2014-05-12' name='data_adaugare'></br>
			</div>
